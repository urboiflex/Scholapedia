<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddCourse.aspx.cs" Inherits="WAPPSS.AddCourse" %>
<!DOCTYPE html>
...
.modern-calendar .TitleStyle {
    ...
    color: #fff !important;
    font-weight: bold;
    background-color: #3c40c1 !important; /* Your desired color */
...
.modern-calendar th {
    ...
    color: #3c40c1;
    font-size: 1.08em;
    border-radius: 8px; /* same as EditCourse */
}
.modern-calendar td {
    background-color: #f5f7fb; /* Your desired day cell color */
    color: #222f3e;
...
/* Navigation Bar Styles (copied/adapted from CourseList, with transparency) */
.settings-container {
    position: fixed;
    top: 18px;
    right: 18px;
...
body {
    background: #f5f7fb; /* Light background for light mode */
    font-family: 'Segoe UI', sans-serif;
    margin: 0;
    padding: 0;
    transition: background 0.4s, color 0.4s;
...
/* --- Modern Calendar Colors Only --- */
.modern-calendar .TitleStyle {
    font-size: 18px !important;
    padding: 10px 0;
    color: #fff !important;
    font-weight: bold;
    background-color: #3c40c1 !important; /* Month bar */
    border-radius: 0 !important;
    border: none !important;
}
.modern-calendar .NextPrevStyle {
    color: #fff !important;
    background-color: #3c40c1 !important; /* Month nav btns */
    border-radius: 0 !important;
    border: none !important;
    font-size: 22px !important;
    font-weight: bold;
...
<form id="form1" runat="server" enctype="multipart/form-data">
        ...
        <div class="form-container">
            ...
            <label id="uploadResourceLabel">Upload Resources (PDF/Video/PPT):</label>
            <input type="file" id="fuResources" name="fuResources" runat="server" multiple accept=".pdf,.ppt,.pptx,video/*" />
            ...
            <asp:UpdatePanel ID="UpdatePanelCalendar" runat="server">
                <ContentTemplate>
                    <asp:Calendar ID="calendarPublish" runat="server" CssClass="modern-calendar"
                        ...
                        OnDayRender="calendarPublish_DayRender">
                        <DayStyle BackColor="#eaf2ff" BorderColor="#b5c9f7" BorderStyle="Solid" BorderWidth="1px" />
