<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DiscussionForum.aspx.cs" Inherits="WAPPSS.DiscussionForum" %>
                        ...
                        <div class='question-item <%# Eval("UserType").ToString().ToLower() == "teacher" ? "teacher" : "student" %>'>
                            <div class="question-title">
                                <asp:HyperLink ID="lnkQuestion" runat="server" 
                                    NavigateUrl='<%# "QuestionDetail.aspx?ID=" + Eval("QuestionID") %>'
