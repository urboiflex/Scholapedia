<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StudentAnnouncements.aspx.cs" Inherits="WAPPSS.StudentAnnouncements" %>
...
<head runat="server">
    ...
    <style>
        ...
        body.dark-mode .target-students {
...
<body>
    <form id="form1" runat="server" class="container mt-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h2 class="mb-0">
                    <i class="bi bi-megaphone-fill me-2"></i>Student Announcements
                </h2>
                ...
                <asp:Panel ID="pnlNoAnnouncements" runat="server" Visible="false" CssClass="text-center py-5">
                    <div class="card">
                        <div class="card-body py-5">
                            ...
                            <p class="text-muted">There are currently no announcements for students.</p>
                        </div>
                    </div>
                </asp:Panel>
            </ContentTemplate>
